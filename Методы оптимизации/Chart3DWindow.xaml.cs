...
namespace OptimizatonMethods
{
    ...
    public partial class Chart3DWindow : Window
    {
        ...
        public void createChart(WPFChartViewer viewer, int chartIndex)
        {
            ...
            c.xAxis().setTitle("Температура в змеевике, С", "Arial Bold Italic", 12);
            c.yAxis().setTitle("Температура в рубашке, С", "Arial Bold Italic", 12);
            c.zAxis().setTitle("Максимальная прибыль", "Arial Bold", 12);
