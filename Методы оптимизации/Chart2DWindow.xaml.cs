...
namespace OptimizatonMethods
{
    ...
    public partial class Chart2DWindow : Window
    {
        ...
        private void drawChart(WPFChartViewer viewer)
        {
            ...
            for (double i = mathModel.tCoilMin - step; i < mathModel.tCoilMax + step; i += step)
            {
                dataX.Add(i);
            }
            for (double i = mathModel.tCasingMin - step; i < mathModel.tCasingMax + step; i += step)
            {
                dataY.Add(i);
            }
            ...
            c.xAxis().setTitle("Температура в змеевике, С", "Arial Bold Italic", 10);
            c.yAxis().setTitle("Температура в рубашке, С", "Arial Bold Italic", 10);
            ...
            c.xAxis().setLinearScale(-3, 15, 1);
            c.yAxis().setLinearScale(-3, 12, 1);
            ...
            cAxis.setTitle("Чем краснее тем выше прибыль", "Arial Bold Italic", 10);
